...
var rootCmd = &cobra.Command{
	...
	Long: `gpc is a fast, lightweight, and scriptable CLI for Google Play Console.
...
func init() {
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default $HOME/.gpc/config.json)")
